...
# and left (you can't, and stay on "1"), so the first button is 1. Starting from
# the previous button ("1"), you move right twice (to "3") and then down three
# times (stopping at "9" after two moves and ignoring the third), ending up with
# 9. Continuing from "9", you move left, up, right, down, and left, ending with
# 8. Finally, you move up four times (stopping at "2"), then down once, ending
# with 5. So, in this example, the bathroom code is 1985.
...
# 5. Continuing from "5", you move right twice and down three times (through
# "6", "7", "B", "D", "D"), ending at D. Then, from "D", you move five more
# times (through "D", "B", "C", "C", "B"), ending at B. Finally, after five more
# moves, you end at 3. So, given the actual keypad layout, the code would be
# 5DB3.

# Using the same instructions in your puzzle input, what is the correct bathroom
# code?

final2 = d2p2.code_from_instructions(instructions)
print('Part II:  Final keycode is %(final2)s.' % locals())
