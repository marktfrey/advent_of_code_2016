...
final = d5.passcode_from_string('ojvtpuvg', 8)
print("ANSWER:")
print('Part I:  Passcode is %(final)s.' % locals())
...
final2 = d5.better_passcode_from_string('ojvtpuvg', 8)
print('Part II: Passcode is %(final2)s.' % locals())
